...
export default function ProductList() {
  ...
  console.log(totalItems, "responseTotla");
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              ...
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900 bg-white">
                    Sort
                    <ChevronDownIcon
              ...
              <button
                type="button"
                className="-m-2 ml-5 p-2 text-gray-400 hover:text-gray-500 sm:ml-7 bg-white"
              >
              ...
              <button
                type="button"
                className="-m-2 ml-4 p-2 text-gray-400 hover:text-gray-500 sm:ml-6 lg:hidden bg-white"
          ...
          <Link to={"/admin/product-form"}>
            <button
              type="submit"
              className="flex w-64 justify-center rounded-md bg-green-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm green:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 mt-4"
            >
              Add New Product
            </button>
          </Link>
...
const DesktopFiltersView = ({ handleSort, handleFilter, filters }) => {
  return (
    <>
      <Transition
        as={Fragment}
